...
DATABASES = {
    'default': {
        ...
        'USER': 'rootuser1', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST':  'database-1.cypvjnlf00i5.ap-south-1.rds.amazonaws.com', # database endpoint is written here
